...
n, m = input("Введите количество элементов множеств: ").split()
first = [int(i) for i in
         input("Введите элементы первого множества: ").split()]
second = [int(j) for j in
         input("Введите элементы второго множества: ").split()]
